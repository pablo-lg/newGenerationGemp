...
import ar.teco.repository.TipoEmpRepository;
...
class TipoEmpResourceIT {
    ...
    private static final Boolean DEFAULT_DEMANDA = false;
    private static final Boolean UPDATED_DEMANDA = true;
    ...
    public static TipoEmp createEntity(EntityManager em) {
        TipoEmp tipoEmp = new TipoEmp().demanda(DEFAULT_DEMANDA).descripcion(DEFAULT_DESCRIPCION);
        return tipoEmp;
    }
    ...
    public static TipoEmp createUpdatedEntity(EntityManager em) {
        TipoEmp tipoEmp = new TipoEmp().demanda(UPDATED_DEMANDA).descripcion(UPDATED_DESCRIPCION);
        return tipoEmp;
    }
    ...
    void createTipoEmp() throws Exception {
        ...
        assertThat(testTipoEmp.getDemanda()).isEqualTo(DEFAULT_DEMANDA);
    ...
    void getAllTipoEmps() throws Exception {
        ...
        restTipoEmpMockMvc
            ...
            .andExpect(jsonPath("$.[*].demanda").value(hasItem(DEFAULT_DEMANDA.booleanValue())))
    ...
    void getTipoEmp() throws Exception {
        ...
        restTipoEmpMockMvc
            ...
            .andExpect(jsonPath("$.demanda").value(DEFAULT_DEMANDA.booleanValue()))
    ...
    void putNewTipoEmp() throws Exception {
        ...
        updatedTipoEmp.demanda(UPDATED_DEMANDA).descripcion(UPDATED_DESCRIPCION);
        ...
        TipoEmp testTipoEmp = tipoEmpList.get(tipoEmpList.size() - 1);
        assertThat(testTipoEmp.getDemanda()).isEqualTo(UPDATED_DEMANDA);
    ...
    void partialUpdateTipoEmpWithPatch() throws Exception {
        ...
        partialUpdatedTipoEmp.demanda(UPDATED_DEMANDA);
    ...
    void fullUpdateTipoEmpWithPatch() throws Exception {
        ...
        partialUpdatedTipoEmp.demanda(UPDATED_DEMANDA).descripcion(UPDATED_DESCRIPCION);
