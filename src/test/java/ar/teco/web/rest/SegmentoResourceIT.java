...
import ar.teco.repository.SegmentoRepository;
...
class SegmentoResourceIT {
    ...
    public static Segmento createEntity(EntityManager em) {
        Segmento segmento = new Segmento().countryName(DEFAULT_COUNTRY_NAME);
        return segmento;
    }
    ...
    public static Segmento createUpdatedEntity(EntityManager em) {
        Segmento segmento = new Segmento().countryName(UPDATED_COUNTRY_NAME);
        return segmento;
    }
    ...
    void createSegmento() throws Exception {
        ...
        assertThat(testSegmento.getCountryName()).isEqualTo(DEFAULT_COUNTRY_NAME);
    }
    ...
    void putNewSegmento() throws Exception {
        ...
        updatedSegmento.countryName(UPDATED_COUNTRY_NAME);
        ...
        Segmento testSegmento = segmentoList.get(segmentoList.size() - 1);
        assertThat(testSegmento.getCountryName()).isEqualTo(UPDATED_COUNTRY_NAME);
    }
    ...
    void fullUpdateSegmentoWithPatch() throws Exception {
        ...
        partialUpdatedSegmento.countryName(UPDATED_COUNTRY_NAME);
