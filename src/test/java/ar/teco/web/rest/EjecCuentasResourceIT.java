...
import ar.teco.repository.EjecCuentasRepository;
...
class EjecCuentasResourceIT {
    ...
    private static final String DEFAULT_COD_VENDEDOR = "AAAAAAAAAA";
    private static final String UPDATED_COD_VENDEDOR = "BBBBBBBBBB";
    ...
    public static EjecCuentas createEntity(EntityManager em) {
        EjecCuentas ejecCuentas = new EjecCuentas()
            ...
            .codVendedor(DEFAULT_COD_VENDEDOR)
    ...
    public static EjecCuentas createUpdatedEntity(EntityManager em) {
        EjecCuentas ejecCuentas = new EjecCuentas()
            ...
            .codVendedor(UPDATED_COD_VENDEDOR)
    ...
    void createEjecCuentas() throws Exception {
        ...
        assertThat(testEjecCuentas.getCodVendedor()).isEqualTo(DEFAULT_COD_VENDEDOR);
        assertThat(testEjecCuentas.getLegajo()).isEqualTo(DEFAULT_LEGAJO);
    }
    ...
    void getAllEjecCuentas() throws Exception {
        ...
        restEjecCuentasMockMvc
            ...
            .andExpect(jsonPath("$.[*].codVendedor").value(hasItem(DEFAULT_COD_VENDEDOR)))
    ...
    void getEjecCuentas() throws Exception {
        ...
        restEjecCuentasMockMvc
            ...
            .andExpect(jsonPath("$.codVendedor").value(DEFAULT_COD_VENDEDOR))
    ...
    void putNewEjecCuentas() throws Exception {
        ...
        assertThat(testEjecCuentas.getCodVendedor()).isEqualTo(UPDATED_COD_VENDEDOR);
        assertThat(testEjecCuentas.getLegajo()).isEqualTo(UPDATED_LEGAJO);
    }
