...
class DespliegueResourceIT {
    ...
    public static Despliegue createEntity(EntityManager em) {
        Despliegue despliegue = new Despliegue().descripcion(DEFAULT_DESCRIPCION);
        return despliegue;
    }
    ...
    public static Despliegue createUpdatedEntity(EntityManager em) {
        Despliegue despliegue = new Despliegue().descripcion(UPDATED_DESCRIPCION);
        return despliegue;
    }
    ...
    void putNewDespliegue() throws Exception {
        ...
        updatedDespliegue.descripcion(UPDATED_DESCRIPCION);
    ...
    void fullUpdateDespliegueWithPatch() throws Exception {
        ...
        partialUpdatedDespliegue.descripcion(UPDATED_DESCRIPCION);
