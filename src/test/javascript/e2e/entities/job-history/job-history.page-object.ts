...
export class JobHistoryDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('newGenerationGempApp.jobHistory.delete.question'));
...
export default class JobHistoryComponentsPage {
  ...
  async deleteJobHistory() {
    ...
    expect(await jobHistoryDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/newGenerationGempApp.jobHistory.delete.question/);
