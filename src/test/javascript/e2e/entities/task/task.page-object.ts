...
export class TaskDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('newGenerationGempApp.task.delete.question'));
...
export default class TaskComponentsPage {
  ...
  async deleteTask() {
    ...
    expect(await taskDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/newGenerationGempApp.task.delete.question/);
