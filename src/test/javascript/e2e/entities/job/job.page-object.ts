...
export class JobDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('newGenerationGempApp.job.delete.question'));
...
export default class JobComponentsPage {
  ...
  async deleteJob() {
    ...
    expect(await jobDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/newGenerationGempApp.job.delete.question/);
