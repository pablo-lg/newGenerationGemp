...
export class RegionDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('newGenerationGempApp.region.delete.question'));
...
export default class RegionComponentsPage {
  ...
  async deleteRegion() {
    ...
    expect(await regionDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/newGenerationGempApp.region.delete.question/);
