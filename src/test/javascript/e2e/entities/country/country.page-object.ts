...
export class CountryDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('newGenerationGempApp.country.delete.question'));
...
export default class CountryComponentsPage {
  ...
  async deleteCountry() {
    ...
    expect(await countryDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/newGenerationGempApp.country.delete.question/);
