...
export class EmployeeDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('newGenerationGempApp.employee.delete.question'));
...
export default class EmployeeComponentsPage {
  ...
  async deleteEmployee() {
    ...
    expect(await employeeDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/newGenerationGempApp.employee.delete.question/);
