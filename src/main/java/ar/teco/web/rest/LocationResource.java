...
import ar.teco.domain.Location;
import ar.teco.repository.LocationRepository;
import ar.teco.service.LocationService;
...
/**
 * REST controller for managing {@link ar.teco.domain.Location}.
 */
@RestController
@RequestMapping("/api")
