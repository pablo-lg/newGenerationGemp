...
import ar.teco.repository.CompetenciaRepository;
...
/**
 * REST controller for managing {@link ar.teco.domain.Competencia}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CompetenciaResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/competencias/{id}", consumes = { "application/json", "application/merge-patch+json" })
