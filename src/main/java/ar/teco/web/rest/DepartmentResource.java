...
import ar.teco.domain.Department;
import ar.teco.repository.DepartmentRepository;
import ar.teco.service.DepartmentService;
...
/**
 * REST controller for managing {@link ar.teco.domain.Department}.
 */
@RestController
@RequestMapping("/api")
