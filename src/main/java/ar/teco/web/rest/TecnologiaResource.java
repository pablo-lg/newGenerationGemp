...
import ar.teco.repository.TecnologiaRepository;
...
/**
 * REST controller for managing {@link ar.teco.domain.Tecnologia}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TecnologiaResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/tecnologias/{id}", consumes = { "application/json", "application/merge-patch+json" })
