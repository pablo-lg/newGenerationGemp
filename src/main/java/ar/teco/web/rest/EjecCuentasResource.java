...
/**
 * REST controller for managing {@link ar.teco.domain.EjecCuentas}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class EjecCuentasResource {
    ...
    public ResponseEntity<EjecCuentas> updateEjecCuentas(
        ...
        @RequestBody EjecCuentas ejecCuentas
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/ejec-cuentas/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<EjecCuentas> partialUpdateEjecCuentas(
        ...
        Optional<EjecCuentas> result = ejecCuentasRepository
            ...
            .map(existingEjecCuentas -> {
                ...
                if (ejecCuentas.getCodVendedor() != null) {
                    existingEjecCuentas.setCodVendedor(ejecCuentas.getCodVendedor());
                }
                if (ejecCuentas.getLegajo() != null) {
                    existingEjecCuentas.setLegajo(ejecCuentas.getLegajo());
                }
