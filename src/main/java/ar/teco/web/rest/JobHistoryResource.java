...
import ar.teco.domain.JobHistory;
import ar.teco.repository.JobHistoryRepository;
import ar.teco.service.JobHistoryService;
...
/**
 * REST controller for managing {@link ar.teco.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
