...
import ar.teco.repository.TipoObraRepository;
...
/**
 * REST controller for managing {@link ar.teco.domain.TipoObra}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TipoObraResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/tipo-obras/{id}", consumes = { "application/json", "application/merge-patch+json" })
