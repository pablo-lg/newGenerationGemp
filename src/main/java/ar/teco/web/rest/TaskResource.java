...
import ar.teco.domain.Task;
import ar.teco.repository.TaskRepository;
import ar.teco.service.TaskService;
...
/**
 * REST controller for managing {@link ar.teco.domain.Task}.
 */
@RestController
@RequestMapping("/api")
