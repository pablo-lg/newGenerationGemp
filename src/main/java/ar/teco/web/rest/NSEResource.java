...
import ar.teco.repository.NSERepository;
...
/**
 * REST controller for managing {@link ar.teco.domain.NSE}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class NSEResource {
     ...
     */
    @PutMapping("/nses/{id}")
    public ResponseEntity<NSE> updateNSE(@PathVariable(value = "id", required = false) final Long id, @RequestBody NSE nSE)
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/nses/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<NSE> partialUpdateNSE(@PathVariable(value = "id", required = false) final Long id, @RequestBody NSE nSE)
        throws URISyntaxException {
