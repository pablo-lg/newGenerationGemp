...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EJECCUENTAS_LIST actions', async () => {
    ...
    it('dispatches FETCH_EJECCUENTAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EJECCUENTAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EJECCUENTAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EJECCUENTAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EJECCUENTAS actions', async () => {
      const expectedActions = [
        {
