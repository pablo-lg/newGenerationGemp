...
export const EjecCuentasDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(ejecCuentasEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="newGenerationGempApp.ejecCuentas.delete.question">Are you sure you want to delete this EjecCuentas?</ModalBody>
      <ModalFooter>
...
export default EjecCuentasDeleteDialog;
