...
export const SegmentoDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="newGenerationGempApp.segmento.delete.question">Are you sure you want to delete this Segmento?</ModalBody>
      <ModalFooter>
