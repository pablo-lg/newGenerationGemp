...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './histo-wf.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HISTOWF_LIST actions', async () => {
    ...
    it('dispatches FETCH_HISTOWF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HISTOWF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HISTOWF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HISTOWF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HISTOWF actions', async () => {
      const expectedActions = [
        {
