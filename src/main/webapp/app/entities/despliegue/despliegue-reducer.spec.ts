...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DESPLIEGUE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DESPLIEGUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DESPLIEGUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DESPLIEGUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DESPLIEGUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DESPLIEGUE actions', async () => {
      const expectedActions = [
        {
