...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './usu-gemp.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USUGEMP_LIST actions', async () => {
    ...
    it('dispatches FETCH_USUGEMP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USUGEMP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USUGEMP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USUGEMP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USUGEMP actions', async () => {
      const expectedActions = [
        {
