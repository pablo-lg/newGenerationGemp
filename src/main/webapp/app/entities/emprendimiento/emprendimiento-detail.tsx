...
export const EmprendimientoDetail = (props: RouteComponentProps<{ id: string }>) => {
    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="codigoObra">Codigo Obra</span>
          </dt>
          <dd>{emprendimientoEntity.codigoObra}</dd>
          <dt>
          ...
          <dt>
            <span id="demanda5">Demanda 5</span>
          </dt>
          <dd>{emprendimientoEntity.demanda5}</dd>
          <dt>
          ...
          <dt>
            <span id="comenCan">Comen Can</span>
          </dt>
          <dd>{emprendimientoEntity.comenCan}</dd>
          <dt>
          ...
          <dd>{emprendimientoEntity.estado}</dd>
          <dt>
            <span id="estadoBC">Estado BC</span>
          </dt>
          <dd>{emprendimientoEntity.estadoBC}</dd>
          <dt>Grupo Emp</dt>
          <dd>{emprendimientoEntity.grupoEmp ? emprendimientoEntity.grupoEmp.descripcion : ''}</dd>
          <dt>Tipo Obra</dt>
