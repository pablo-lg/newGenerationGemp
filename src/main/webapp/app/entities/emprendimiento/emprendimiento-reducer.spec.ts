...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPRENDIMIENTO_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPRENDIMIENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPRENDIMIENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPRENDIMIENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPRENDIMIENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPRENDIMIENTO actions', async () => {
      const expectedActions = [
        {
