...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './nse.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NSE_LIST actions', async () => {
    ...
    it('dispatches FETCH_NSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NSE actions', async () => {
      const expectedActions = [
        {
