...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tipo-emp.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TIPOEMP_LIST actions', async () => {
    ...
    it('dispatches FETCH_TIPOEMP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TIPOEMP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TIPOEMP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TIPOEMP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TIPOEMP actions', async () => {
      const expectedActions = [
        {
