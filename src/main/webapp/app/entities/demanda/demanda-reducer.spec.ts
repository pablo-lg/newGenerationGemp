...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './demanda.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEMANDA_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEMANDA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEMANDA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEMANDA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEMANDA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEMANDA actions', async () => {
      const expectedActions = [
        {
