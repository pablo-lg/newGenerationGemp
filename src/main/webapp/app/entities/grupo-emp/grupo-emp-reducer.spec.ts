...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './grupo-emp.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GRUPOEMP_LIST actions', async () => {
    ...
    it('dispatches FETCH_GRUPOEMP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GRUPOEMP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GRUPOEMP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GRUPOEMP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GRUPOEMP actions', async () => {
      const expectedActions = [
        {
