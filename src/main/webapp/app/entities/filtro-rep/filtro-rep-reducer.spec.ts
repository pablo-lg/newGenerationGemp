...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILTROREP_LIST actions', async () => {
    ...
    it('dispatches FETCH_FILTROREP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FILTROREP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FILTROREP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FILTROREP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FILTROREP actions', async () => {
      const expectedActions = [
        {
