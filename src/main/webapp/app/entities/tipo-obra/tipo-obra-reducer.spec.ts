...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tipo-obra.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TIPOOBRA_LIST actions', async () => {
    ...
    it('dispatches FETCH_TIPOOBRA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TIPOOBRA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TIPOOBRA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TIPOOBRA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TIPOOBRA actions', async () => {
      const expectedActions = [
        {
