...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPETENCIA_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPETENCIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPETENCIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPETENCIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPETENCIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPETENCIA actions', async () => {
      const expectedActions = [
        {
