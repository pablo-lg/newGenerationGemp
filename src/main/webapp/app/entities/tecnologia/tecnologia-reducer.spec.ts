...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TECNOLOGIA_LIST actions', async () => {
    ...
    it('dispatches FETCH_TECNOLOGIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TECNOLOGIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TECNOLOGIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TECNOLOGIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TECNOLOGIA actions', async () => {
      const expectedActions = [
        {
