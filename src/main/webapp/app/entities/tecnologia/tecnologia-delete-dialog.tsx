...
export const TecnologiaDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(tecnologiaEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="newGenerationGempApp.tecnologia.delete.question">Are you sure you want to delete this Tecnologia?</ModalBody>
      <ModalFooter>
...
export default TecnologiaDeleteDialog;
